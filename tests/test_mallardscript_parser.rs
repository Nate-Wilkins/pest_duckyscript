...
/// Test valid MallardScript input.
macro_rules! test_parser_input_valid {
    ($($name:ident: $value:expr,)*) => {
    $(
        #[test]
        fn $name() -> Result<(), Box<dyn std::error::Error>> {
            // Given a MallardScript parser.
            // And a MallardScript script input that is valid.
...
/// Test invalid MallardScript input.
macro_rules! test_parser_input_invalid {
    ...
    $(
        ...
        fn $name() -> Result<(), Box<dyn std::error::Error>> {
            // Given a MallardScript parser.
            // And a MallardScript script input that is invalid.
